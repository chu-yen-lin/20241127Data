...
public class GmailOAuthSender {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
        	sendMessage(service, "me", createEmail("peter2800@yahoo.com.tw", "title", "這裡要打內文"));
    ...
    public static Gmail getGmailService() throws Exception {
    	//clearStoredTokens();
        GoogleClientSecrets clientSecrets = GoogleClientSecrets.load(JSON_FACTORY, new InputStreamReader(GmailOAuthSender.class.getResourceAsStream("/client_secret_880557858847-dlpp41sivg89i2d1nehjsmtl5i2cv2kd.apps.googleusercontent.com.json")));
